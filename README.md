...
|---|---|---|
| `INSTAGRAM_USERNAME` | Usuário ou email do Instagram | `meu_usuario` |
| `INSTAGRAM_PASSWORD` | Senha do Instagram | `minha_senha` |
...
> `MAX_POSTS_PER_PROFILE` é opcional — o padrão é `5` se não configurado.
...
Para enviar emails pelo Gmail, você precisa criar uma **App Password**:
